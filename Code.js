...
/**
 * API endpoint to handle data requests and return JSON.
 * This function acts as a router for different API actions.
 *
  ...
  try {
    ...
    switch (action) {
      ...
      case 'testConnection':
        ...
        break;
      default:
        data = { success: false, error: 'Invalid action specified.' };
    }
  } catch (error) {
    console.error('API Error:', error);
    data = { success: false, error: `An unexpected error occurred: ${error.message}` };
  }
